...
async function loadAdminSettings() {
  try {
    ...
    if (document.getElementById('settingGroqKey')) document.getElementById('settingGroqKey').value = s.groqKey || '';
    if (document.getElementById('settingOllamaEndpoint')) document.getElementById('settingOllamaEndpoint').value = s.ollamaEndpoint || '';
  } catch (err) {
...
async function handleSaveSettings(e) {
  ...
  const payload = {
    ...
    groqKey: document.getElementById('settingGroqKey') ? document.getElementById('settingGroqKey').value.trim() : '',
    ollamaEndpoint: document.getElementById('settingOllamaEndpoint') ? document.getElementById('settingOllamaEndpoint').value.trim() : ''
  };
